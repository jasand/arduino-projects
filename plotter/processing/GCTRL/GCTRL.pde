...
//-------------------------------------------------------------------------------------------------
// Copied from https://circuitdigest.com/microcontroller-projects/arduino-cnc-machine-project-code
// and modified to use G21 and millimeters
//-------------------------------------------------------------------------------------------------
...
void draw()
{
  ...
  text("1: set speed to 0.1 mm per jog", 12, y); y += dy;
  text("2: set speed to 1.0 mm per jog", 12, y); y += dy;
  text("3: set speed to 10 mm per jog", 12, y); y += dy;
